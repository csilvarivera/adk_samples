# PDF Translator Fraud Agent

## Overview
This project demonstrates a PDF Translator Fraud Agent designed to translate a PDF document to English and analyze it for fraud. It leverages the latest Gemini models and integrates with Vertex AI endpoints for specialized predictions.

...
from pdf_translator_fraud_agent.agent import root_agent
...
def deploy_agent():
  ...
  remote_agent = agent_engines.create(
      root_agent,
       ...
       extra_packages= ["pdf_translator_fraud_agent/agent.py", 
                        "pdf_translator_fraud_agent/subagents/translator_agent/",
                        "pdf_translator_fraud_agent/subagents/fraud_agent/"
      ],
      display_name="pdf_translator_fraud_agent "
  )

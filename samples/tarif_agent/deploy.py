...
def deploy_agent():
  ...
  remote_agent = agent_engines.create(
      ...
      extra_packages= ["tariff_agent/agent.py", 
                       "tariff_agent/common_utils/",
                       "tariff_agent/sub_agents/risk_mitigation_agent/",
                       "tariff_agent/sub_agents/scenario_planning_agent/",
                       "tariff_agent/sub_agents/tariff_news_agent/"],
      display_name="tariffs_agent"
  )
...
def call_agent():
  ...
  for event in agent.stream_query(
    ...
    message="Help me understanding a scenario with the impact of the tariffs",
  ):
    print(event)

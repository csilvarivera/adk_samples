...
cepf_logger = cepf_log_client.logger("cepf-github-agent") 
...
def main():
    ...
    search_repo_skills = AgentSkill(
        id='search_repositories',
        name='Search Repositories',
        description='returns repo info',
        tags=['Search repositories'],
        examples=['Search repository 123', 'Give me the details of repository 456'],
    )

    search_issues_skills = AgentSkill(
        id='search_issues',
        name='Search Issues',
        description='returns issue info',
        tags=['Search Issues'],
        examples=['Search Issue 123', 'Give me the details of issue 456'],
    )

    list_issues_skills = AgentSkill(
        id='list_issues',
        name='List Issues',

...
import sys
import vertexai
from adk_lab.utils.proxy import STAGING_BUCKET_URI, PROJECT_ID 
...
def deploy_agent():
    ...
    deployed_agent = reasoning_engines.ReasoningEngine.create(
        app_for_deployment,
        display_name="Code Assistant Agent",  #### Do not change this, otherwise other activity tracking fails

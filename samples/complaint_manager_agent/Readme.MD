...
## Overview
This project demonstrates a multi-agent system designed to retrieve invoice detials and performs operations over a complaint management systems checks. The system is built to interact with BigQuery & Google Search and it leverages the latest Gemini 2.5 pro.
